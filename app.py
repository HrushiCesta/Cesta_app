...
st.set_page_config(page_title="MedFair Analytics Dashboard", layout="wide")
...
# --- HOME PAGE ---
if section == "Home":
    st.title("🏥 MedFair Data Pipeline")
...
# --- CATEGORY ANALYTICS ---
    ...
    selected_state = st.selectbox("👇 Select a state to view CATEGORY breakdown:", states["STATE"])
